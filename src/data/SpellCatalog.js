export const SPELLS = {
    ...
    'air,air,fire': { name: 'Firestorm', element: 'air', combo: ['air', 'air', 'fire'], damage: 1, shield: 0, draw: 0, drain: 2, synergyType: 'constructive', synergyText: 'Constructive: Next played mana deals 3 damage to opponent', desc: '1 DMG, Drain 2. Constructive: Next played mana deals 3 damage to opponent' },
    ...
    'earth,fire,fire': { name: 'Surge', element: 'fire', combo: ['earth', 'fire', 'fire'], damage: 3, shield: 3, draw: 0, drain: 0, synergyType: 'destructive', synergyText: 'Destructive: Next mana played by opponent deals 3 damage to them', desc: '3 DMG, +3 Shield. Destructive: Next mana played by opponent deals 3 damage to them' },
